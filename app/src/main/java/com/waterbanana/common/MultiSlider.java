...
public class MultiSlider extends View {
    ...
    public MultiSlider(Context context, AttributeSet attrs, int defStyle, int styleRes) {
        ...
        if(trackDrawable ==  null)
            trackDrawable = getResources().getDrawable(R.drawable.multislider_scrubber_track_holo_light);
...
//        mMaxHeight = a.getDimensionPixelSize(R.styleable.MultiSlider_maxHeight, mMaxHeight);
        ...
        if(thumbDrawable==null) thumbDrawable = getResources().getDrawable(R.drawable.multislider_scrubber_control_selector_holo_light);

        Drawable range = a.getDrawable(R.styleable.MultiSlider_range);
        if(range==null) range = getResources().getDrawable(R.drawable.multislider_scrubber_primary_holo);
